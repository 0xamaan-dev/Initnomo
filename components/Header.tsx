            ...
            <div className="flex items-center gap-2 sm:gap-4">
                {pathname === '/' && (
                    <div className="hidden xl:flex items-center gap-3 text-[10px] font-bold uppercase tracking-widest text-white/55">
                        <a href="https://github.com/0xamaan-dev/Initnomo" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">GitHub</a>
                        <a href="https://docs.google.com/presentation/d/1cZuB4i57buCZ2ZyNFNVLxY-qlLUSyTV33J7doVjnMi8/edit?usp=sharing" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Pitch Deck</a>
                    </div>
                )}
