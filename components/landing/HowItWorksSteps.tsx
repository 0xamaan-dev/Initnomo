...
const STEPS: {
...
}[] = [
    {
        ...
        description:
            'Connect your wallet and deposit to the INITNOMO treasury. Once recorded, your balance updates in the house balance (Supabase) so you can bet instantly without on-chain bet transactions.',
        accent: '#3b82f6',
    ...
    },
    {
        ...
        description:
            'At expiry, INITNOMO resolves from oracle prices by mode: Classic checks direction, Box checks whether the close lands inside your box, and Draw checks your drawn region. Results and payouts are posted to history.',
        accent: '#f59e0b',
