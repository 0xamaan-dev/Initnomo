        ...
        <div className="dexscreener-header">
          ...
          <div className="dexscreener-title-row">
            <h2 className="dexscreener-title">
              INITNOMO / SOL <span className="dexscreener-title-muted">Solana · Meteora</span>
            </h2>

            <a className="dexscreener-cta" href={DEXSCREENER_PAIR_URL} target="_blank" rel="noopener noreferrer">
              View chart
            </a>
          </div>

          <p className="dexscreener-subtitle">Real-time chart, liquidity, and trade activity.</p>
        </div>

        <div className="dexscreener-embed-slot">
          <div id="dexscreener-embed">
            <iframe src={DEXSCREENER_EMBED_URL} title="Dexscreener chart" allow="clipboard-write; fullscreen" loading="lazy" />
          </div>
        </div>
      </div>
    </section>
