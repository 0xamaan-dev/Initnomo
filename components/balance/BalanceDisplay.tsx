  ...
  return (
    <>
      <div className="bg-black/30 rounded-xl border border-white/5 overflow-hidden">
        {/* Secret Demo Header - Only visible when activated via INITNOMO logo click */}
        {accountType === 'demo' && (
            ...
            <div className="flex items-center gap-2">
              ...
              {network === 'SOL' && accountType === 'real' && (
                <div className="flex bg-white/5 rounded-lg p-0.5 border border-white/10">
                  ...
                  <button
                    onClick={() => {
                      setSelectedCurrency('INITNOMO');
                      setTimeout(() => fetchBalance(address!), 100);
                    }}
                    className={`px-2 py-0.5 rounded text-[8px] font-black uppercase transition-all ${selectedCurrency === 'INITNOMO'
                      ? 'bg-purple-500 text-white shadow-lg'
                      : 'text-white/40 hover:text-white/60'
                      }`}
                  >
            ...
            {isLoading && accountType === 'real' ? (
              ...
              <div className="flex items-center gap-1.5">
                <div className="flex items-center gap-1">
                  <img
                    src={
                      currentSymbol === 'INITNOMO' ? '/overflowlogo.png' :
