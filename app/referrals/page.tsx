                    ...
                    >
                        <div className="space-y-4">
                            <div className="flex items-center gap-3 px-4 py-1.5 bg-purple-500/10 border border-purple-500/20 rounded-full w-fit">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-[0.3em] text-purple-400">Initia Growth Protocol</span>
                            </div>
                            <h1 className="text-5xl md:text-7xl font-black tracking-tighter uppercase" style={{ fontFamily: 'var(--font-orbitron)' }}>
                                Initia <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400 text-glow-purple">Referrals</span>
                            </h1>
                            <p className="text-white/30 text-sm font-bold uppercase tracking-widest leading-relaxed max-w-xl">
                                Expand the Initnomo Initia network. Earn 10% from every trade made by your referred wallets.
                            </p>
                        </div>
                    </motion.div>
                </header>
