...
export default function LeaderboardPage() {
    ...
    const [networkFilter, setNetworkFilter] = useState('INIT');
    ...
    const getNetworkIcon = (network: string) => {
        switch (network) {
            ...
            default: return '/logos/initia.png';
        }
    };
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
                    <div className="space-y-4">
                        ...
                        <motion.p
                            ...
                            The elite traders of the Initnomo protocol, ranked by net profit on Initia.
                        </motion.p>
                    </div>
